...
import com.runehive.content.Waypoints;
...
import com.runehive.util.tools.LogPrinter;
import com.runehive.util.tools.LogReader;
...
public class PlayerCommandPlugin extends CommandExtension {
    ...
    protected void register() {
     ...
     commands.add(new Command("voted", "claimvote", "claimvotes") {
        ...
        commands.add(new Command("gpt") {
            @Override
            public void execute(Player player, CommandParser parser) {
                if (!parser.hasNext()) {
                    player.message("Usage: ::gpt <your message>");
                    player.message("Example: ::gpt Who are you?");
                    return;
                }
                
                StringBuilder message = new StringBuilder();
                while (parser.hasNext()) {
                    message.append(parser.nextString()).append(" ");
                }
                
                com.runehive.content.ai.AIDialogueHandler.handleAICommand(player, message.toString().trim());
            }
        });
    }
