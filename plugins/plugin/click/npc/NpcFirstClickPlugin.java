...
import com.runehive.content.activity.impl.magearena.MageArena;
import com.runehive.content.activity.impl.recipefordisaster.RecipeForDisaster;
...
import com.runehive.content.dialogue.impl.*;
...
import com.runehive.content.store.impl.SkillcapeStore;
...
import static com.runehive.content.pet.PetData.JAD;
...
public class NpcFirstClickPlugin extends PluginContext {
    ...
    protected boolean firstClickNpc(Player player, NpcClickEvent event) {
        ...
        if (LazyAIManager.handleGandalfAIClick(player, event.getNpc())) {
            return true;
        }
