package com.runehive.net.codec.login;

import com.runehive.Config;
import com.runehive.net.codec.IsaacCipher;
import com.runehive.net.session.LoginSession;
...
import org.jire.runehiveps.ByteBufUtil;
...
public final class LoginDecoder extends ByteToMessageDecoder {
    ...
    private void decodeHandshake(ChannelHandlerContext ctx, ByteBuf in) {
        ...
        channel.attr(Config.SESSION_KEY).set(new LoginSession(channel));
