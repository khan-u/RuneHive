package com.runehive.content.shootingstar;

import com.runehive.content.skill.impl.mining.PickaxeData;
...
public class ShootingStar {
    ...
    private static final Logger logger = LogManager.getLogger(ShootingStar.class);
