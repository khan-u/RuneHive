...
public final class DialogueFactory {
    ...
    private static final Logger logger = LogManager.getLogger(DialogueFactory.class);
    ...
    public void clear() {
        ...
        // Clear cached interface strings so dialogue can be replayed
    ...
    final DialogueFactory sendPlayerChat(PlayerDialogue dialogue) {
        ...
        // Player speaking → camera behind player, looking at NPC (+slightly faster turn)
    ...
    final DialogueFactory sendNpcChat(NpcDialogue dialogue) {
        ...
        String[] lines = dialogue.getLines();
        validateLength(lines);
        // NPC speaking → camera behind NPC, looking at player (+slightly faster turn)
