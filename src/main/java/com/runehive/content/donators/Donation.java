package com.runehive.content.donators;
...
public class Donation {
    ...
    private static final Logger logger = LogManager.getLogger(Donation.class);
    ...
    public void redeem(DonatorBond bond) {
        ...
        World.sendMessage("<col=CF2192>osroyale: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has opened <col=CF2192>" + Utility.formatEnum(bond.name()) + "");
        updateRank(false);
    }
