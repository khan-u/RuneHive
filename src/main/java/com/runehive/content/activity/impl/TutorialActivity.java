...
package com.runehive.content.activity.impl;
...
import com.runehive.net.packet.out.SendSpecialAmount;
import com.runehive.util.Utility;

import static com.runehive.content.skill.impl.magic.teleport.TeleportationData.MODERN;
    ...
    protected void start() {
        switch (stage) {
            ...
            case 3:
                ...
                factory.sendNpcChat(306, "Welcome to <col=D63E3E>osroyale</col>, " + player.getName(), "Would you like a tutorial of our lands?");
