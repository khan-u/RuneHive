...
import com.runehive.net.session.Session;
...
public final class Config {
    ...
    public static final String LATEST_ANNOUNCEMENT_THREAD = "";

    /** The latest update thread link. */
    public static final String LATEST_UPDATE_THREAD = "";
    ...
    public static boolean DISABLE_BROADCASTS = true;
