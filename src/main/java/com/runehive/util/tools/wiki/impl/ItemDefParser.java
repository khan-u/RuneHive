package com.runehive.util.tools.wiki.impl;
...
import com.runehive.util.tools.wiki.parser.WikiTable;
import com.runehive.util.tools.wiki.parser.WikiTableParser;
...
import static com.runehive.game.world.entity.combat.CombatConstants.BONUS_CONFIG_FIELD_NAMES;

public class ItemDefParser extends WikiTableParser {

    private static final Logger logger = LogManager.getLogger(ItemDefParser.class);
