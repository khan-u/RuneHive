...
import com.runehive.content.skill.impl.slayer.SlayerTab;
...
import com.runehive.game.event.impl.*;
import com.runehive.game.event.impl.log.CommandLogEvent;
import com.runehive.game.event.impl.log.PickupItemLogEvent;
import com.runehive.game.event.listener.PlayerEventListener;
...
public class PluginContext implements PlayerEventListener {
    ...
    public static final Logger logger = LogManager.getLogger(PluginContext.class);
    ...
    protected boolean onClick(final Player player, final int button) {
        switch (button) {
            case 29404:
                player.send(new SendURL("https://runehive.com"));
                return true;
            case 29408:
