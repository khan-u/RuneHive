...
import com.runehive.net.ServerPipelineInitializer;
...
public final class NetworkService {
	...
	public void start(int port) throws Exception {
		...
		try {
			...
			RuneHive.serverStarted.set(true);

			logger.info(String.format("Server built successfully (took %d seconds).", RuneHive.UPTIME.elapsedTime(TimeUnit.SECONDS)));
			RuneHive.UPTIME.reset();
