...
import com.runehive.content.ItemCreation;
...
import com.runehive.net.packet.out.SendScreenshot;
import com.runehive.util.Items;
import com.runehive.util.RandomGen;
 ...
 *
 * @author <a href="https://runehive.com">Stand Up</a>
 * @since 29-1-2017.
 */
...
//            }
            ...
            if (killer.settings.dropNotification && item.getValue() > 1_000_000) {
                ...
                World.sendMessage("<col=BA383E>osroyale: <col=" + killer.right.getColor() + ">" + killer.getName() + " </col>has just received " + Utility.getAOrAn(name) + " <col=BA383E>" + name + " </col>from <col=BA383E>" + npc.getName() + "</col>!");
    ...
    private static void handleMessages(Player player, Npc npc, Item item) {
        ...
        if (player.settings.dropNotification && item.getValue() > 1_000_000) {
            ...
            World.sendMessage("<col=BA383E>osroyale: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has just received " + Utility.getAOrAn(name) + " <col=BA383E>" + name + " </col>from <col=BA383E>" + npc.getName() + "</col>!");
