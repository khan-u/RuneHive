...
import com.runehive.content.event.impl.OnKillEvent;
import com.runehive.content.itemaction.impl.CrawsBow;
import com.runehive.content.itemaction.impl.ThammaronsSceptre;
import com.runehive.content.itemaction.impl.ViggorasChainmace;
...
import com.runehive.game.world.entity.mob.MobDeath;
    ...
    public void postDeath(Mob killer) {
        ...
        if (!safe) {
            ...
            if (mob.right == PlayerRight.HARDCORE_IRONMAN) {
                ...
                World.sendMessage("<icon=1> <col=FF0000>osroyale: <col=" + mob.right.getColor() + ">" + mob.getName() + "</col>'s hardcore iron man account was lost!");
            }
        }
