...
import com.runehive.game.service.HighscoreService;
import com.runehive.game.service.PostgreService;
...
import static com.runehive.util.GsonUtils.JSON_PRETTY_ALLOW_NULL;

public final class PlayerPersistDB implements PlayerPersistable {

    private static final Logger logger = LogManager.getLogger(PlayerPersistDB.class);
