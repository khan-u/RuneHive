...
public final class CombatListenerManager {
    ...
    private static final Logger logger = LogManager.getLogger(CombatListenerManager.class);
    ...
    public static void load() {
        loadItems("com.runehive.game.world.entity.combat.attack.listener.item");
        loadNpcs("com.runehive.game.world.entity.combat.attack.listener.npc");
    }
