...
import com.runehive.content.EmblemData;
import com.runehive.content.clanchannel.content.ClanAchievement;
...
import static com.runehive.content.clanchannel.content.ClanTaskKey.PLAYER_KILLING;
...
public class PlayerKilling {
    ...
    public static void handle(Player killer, Player victim) {
        ...
        if (killer.clanChannel != null && victim.clanChannel != null && killer.clanChannel.getName().equalsIgnoreCase(victim.clanChannel.getName())) {
            if (!killer.clanChannel.getName().equals("osroyale")) {
