...
import com.runehive.game.world.entity.combat.strategy.npc.boss.*;
import com.runehive.game.world.entity.combat.strategy.npc.boss.armadyl.FlightKilisa;
import com.runehive.game.world.entity.combat.strategy.npc.boss.armadyl.FlockleaderGeerin;
import com.runehive.game.world.entity.combat.strategy.npc.boss.armadyl.KreeArra;
import com.runehive.game.world.entity.combat.strategy.npc.boss.armadyl.WingmanSkree;
import com.runehive.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothPrime;
import com.runehive.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothRex;
import com.runehive.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothSupreme;
import com.runehive.game.world.entity.combat.strategy.npc.boss.dagannoths.Spinolyp;
import com.runehive.game.world.entity.combat.strategy.npc.boss.kril.Balfrug;
import com.runehive.game.world.entity.combat.strategy.npc.boss.kril.Tstanon;
import com.runehive.game.world.entity.combat.strategy.npc.boss.kril.Zakln;
import com.runehive.game.world.entity.combat.strategy.npc.boss.magearena.Derwen;
import com.runehive.game.world.entity.combat.strategy.npc.boss.magearena.Justiciar;
import com.runehive.game.world.entity.combat.strategy.npc.boss.magearena.Porazdir;
import com.runehive.game.world.entity.combat.strategy.npc.boss.scorpia.Scorpia;
import com.runehive.game.world.entity.combat.strategy.npc.boss.scorpia.ScorpiaGuardian;
import com.runehive.game.world.entity.combat.strategy.npc.boss.scorpia.ScorpiaOffspring;
import com.runehive.game.world.entity.combat.strategy.npc.boss.skotizo.Skotizo;
import org.jire.runehiveps.kalphitequeen.KalphiteQueen;
